...
public class DockableWindowFactory {
    ...
    class Window {
        ...
        class ToggleAction extends EditAction {
            ...
            //{{{ invoke() method
            public void invoke(View view) {
                view.getDockableWindowManager().toggleDockableWindow(dockable);
            //}}}
            }
            ...
            @Override
            public String getCode() {
                return "view.getDockableWindowManager()" + ".toggleDockableWindow(\"" + dockable + "\");";
            //}}}
            }
            //}}}
        }
        ...
        class FloatAction extends EditAction {
            ...
            //{{{ invoke() method
            public void invoke(View view) {
                view.getDockableWindowManager().floatDockableWindow(dockable);
            //}}}
            }
            ...
            @Override
            public String getCode() {
                return "view.getDockableWindowManager()" + ".floatDockableWindow(\"" + dockable + "\");";
            //}}}
            }
            //}}}
        }
