...
public class MouseOptionPane extends AbstractOptionPane {
    ...
    private static final String[] clickActionKeys = new String[] { "toggle-fold", "toggle-fold-fully" };

    private static final String[] clickModifierKeys = new String[] { "foldClick", "SfoldClick" };
    //}}}
}
