...
public class AboutDialog extends JDialog implements ActionListener {
    ...
    private static class AboutPanel extends JComponent implements Runnable {
        ...
        private int iLineHeight = 0, iListHeight, iLineCount = 0, iBottomLineXOffset = 0, iBottomLineYOffset = 0, iPipeLineCount = 0, w = 0, h = 0, y = 0;

        private static final int SLEEP_TIME = 30, iBottomPadding = 36, iTopPadding = 120;
