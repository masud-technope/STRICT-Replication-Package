...
public class KeyEventTranslator {
    ...
    private static final int[] MODS = { InputEvent.CTRL_DOWN_MASK, InputEvent.ALT_DOWN_MASK, InputEvent.META_DOWN_MASK, InputEvent.SHIFT_DOWN_MASK };
    ...
    static {
        if (OperatingSystem.isMacOS()) {
            setModifierMapping(InputEvent.META_DOWN_MASK, InputEvent.CTRL_DOWN_MASK, /* M+ discarded by key event workaround! */
            InputEvent.ALT_DOWN_MASK, InputEvent.SHIFT_DOWN_MASK);
        } else {
            setModifierMapping(InputEvent.CTRL_DOWN_MASK, InputEvent.ALT_DOWN_MASK, InputEvent.META_DOWN_MASK, InputEvent.SHIFT_DOWN_MASK);
        }
    }
